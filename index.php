...
include ('includes/MyunaAPI.php');

if ( !class_exists( 'MyunaAPI_Plugin' ) ) {
    class MyunaAPI_Plugin
    {
        public static function init() {

            add_action( 'init', ['MyunaAPI_Plugin', 'myuna_api_register_post_type'] );

            add_action( 'admin_menu', ['MyunaAPI_Plugin', 'myuna_api_settings_menu'] );

            add_action( 'admin_init', ['MyunaAPI_Plugin', 'myuna_api_plugin_settings'] );

            add_action( 'admin_init', ['MyunaAPI_Plugin', 'myuna_api_js_css'] );
        ...
        function myuna_api_settings_menu() {
            add_options_page( 'Myuna API Settings', 'Myuna API Setting', 'manage_options', 'myuna-api-setting', ['MyunaAPI_Plugin', 'myuna_api_settings_page'] );
        }
        ...
        function myuna_api_plugin_settings() {
            register_setting( 'myuna_api_plugin_options', 'myuna_api_plugin_options', ['MyunaAPI_Plugin', 'myuna_api_plugin_options_validate'] );
            add_settings_section( 'myuna_api_settings', 'Myuna API Settings', ['MyunaAPI_Plugin', 'myuna_api_plugin_section_text'], 'myuna_api_plugin' );
        
            add_settings_field( 'myuna_api_times', 'Times to run every day', ['MyunaAPI_Plugin', 'myuna_api_plugin_setting_times'], 'myuna_api_plugin', 'myuna_api_settings' );
        }
